...
const SalesMasterclass: React.FC<SalesMasterclassProps> = ({
  ...
  return (
    ...
    >
      ...
      {/* Note: Video outro disabled - no VIDEO_CONFIG.OUTRO_VIDEO_URL configured */}
      {showOutroVideo && VIDEO_CONFIG.OUTRO_VIDEO_URL && (
        <div className={educationalMode ? "min-h-screen bg-black/95 flex items-center justify-center p-4" : "pt-20 flex items-center justify-center min-h-screen px-3"}>
          <IntroVideoGate
            videoUrl={VIDEO_CONFIG.OUTRO_VIDEO_URL}
            title={VIDEO_CONFIG.OUTRO_TITLE}
            subtitle={VIDEO_CONFIG.OUTRO_SUBTITLE}
            allowSkip={VIDEO_CONFIG.ALLOW_SKIP_OUTRO}
            skipAfterSeconds={VIDEO_CONFIG.SKIP_OUTRO_AFTER_SECONDS}
            onVideoComplete={() => {
