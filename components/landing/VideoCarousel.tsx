...
export function VideoCarousel() {
  ...
  return (
    <div className="relative w-full max-w-md mx-auto">
      ...
      {/* Floating elements - RIGHT SIDE (using CSS translate to prevent horizontal scroll) */}
      <div className="absolute -top-6 left-full float-offset-right-20 lg:float-offset-right-28 p-2 rounded-lg text-xs glass-crystal" style={{ animation: 'float 4s ease-in-out infinite 0.5s' }}>
        <span className="font-medium text-purple-600 dark:text-purple-400">Open</span>
      </div>

      <div className="absolute top-4 left-full float-offset-right-28 lg:float-offset-right-40 p-2 rounded-lg text-xs glass-crystal" style={{ animation: 'float 5s ease-in-out infinite 1s' }}>
        <span className="font-medium text-blue-600 dark:text-blue-400">Secure</span>
      </div>

      <div className="absolute top-20 left-full float-offset-right-24 lg:float-offset-right-32 p-2 rounded-lg text-xs glass-crystal" style={{ animation: 'float 4.5s ease-in-out infinite 0.2s' }}>
        <span className="font-medium text-green-600 dark:text-green-400">Human</span>
      </div>

      <div className="absolute top-36 left-full float-offset-right-32 lg:float-offset-right-48 p-2 rounded-lg text-xs glass-crystal" style={{ animation: 'float 5.5s ease-in-out infinite 1.5s' }}>
        <span className="font-medium text-cyan-600 dark:text-cyan-400">Gift in 5 min</span>
      </div>

      <div className="absolute bottom-12 left-full float-offset-right-20 lg:float-offset-right-28 p-2 rounded-lg text-xs glass-crystal" style={{ animation: 'float 4.3s ease-in-out infinite 0.7s' }}>
        <span className="font-medium text-teal-600 dark:text-teal-400">Easy claim</span>
      </div>

      <div className="absolute bottom-28 left-full float-offset-right-36 lg:float-offset-right-52 p-2 rounded-lg text-xs glass-crystal" style={{ animation: 'float 5.8s ease-in-out infinite 1.8s' }}>
