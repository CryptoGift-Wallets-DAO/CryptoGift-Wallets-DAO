...
export function VideoCarousel() {
  ...
  return (
    <div className="relative w-full max-w-md mx-auto">
      ...
      {/* Floating elements - RIGHT SIDE (using transform to avoid horizontal scroll) */}
      <div className="absolute -top-6 right-0 translate-x-[5rem] lg:translate-x-[7rem] p-2 rounded-lg text-xs glass-crystal" style={{ animation: 'float 4s ease-in-out infinite 0.5s' }}>
        <span className="font-medium text-purple-600 dark:text-purple-400">Open</span>
      </div>

      <div className="absolute top-4 right-0 translate-x-[7rem] lg:translate-x-[10rem] p-2 rounded-lg text-xs glass-crystal" style={{ animation: 'float 5s ease-in-out infinite 1s' }}>
        <span className="font-medium text-blue-600 dark:text-blue-400">Secure</span>
      </div>

      <div className="absolute top-20 right-0 translate-x-[6rem] lg:translate-x-[8rem] p-2 rounded-lg text-xs glass-crystal" style={{ animation: 'float 4.5s ease-in-out infinite 0.2s' }}>
        <span className="font-medium text-green-600 dark:text-green-400">Human</span>
      </div>

      <div className="absolute top-36 right-0 translate-x-[8rem] lg:translate-x-[12rem] p-2 rounded-lg text-xs glass-crystal" style={{ animation: 'float 5.5s ease-in-out infinite 1.5s' }}>
        <span className="font-medium text-cyan-600 dark:text-cyan-400">Gift in 5 min</span>
      </div>

      <div className="absolute bottom-12 right-0 translate-x-[5rem] lg:translate-x-[7rem] p-2 rounded-lg text-xs glass-crystal" style={{ animation: 'float 4.3s ease-in-out infinite 0.7s' }}>
        <span className="font-medium text-teal-600 dark:text-teal-400">Easy claim</span>
      </div>

      <div className="absolute bottom-28 right-0 translate-x-[9rem] lg:translate-x-[13rem] p-2 rounded-lg text-xs glass-crystal" style={{ animation: 'float 5.8s ease-in-out infinite 1.8s' }}>
