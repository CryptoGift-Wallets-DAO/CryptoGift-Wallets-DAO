...
export function ProfileFullCard() {
  ...
  const modalContent = (
    ...
    <div
      ...
      className="fixed z-[99999] top-24 right-0 w-[420px] max-w-[calc(100vw-16px)] max-h-[calc(100vh-120px)] overflow-y-auto bg-white dark:bg-slate-900 rounded-2xl shadow-2xl border border-gray-200/50 dark:border-slate-700/50 animate-expandIn origin-top-right"
    >
